...
Before, this was only allowed for mathematical operations such as `+` or `*` (see the rule [operator-assignment](https://github.com/eslint/eslint/tree/main/docs/src/rules/operator-assignment)).
